const declinePermissionEmail = (emailAddress, userName) => {
  const title = "בקשתך ליומן נדחתה";
  const body = `בקשתך ליומן ${userName} - ${emailAddress} נדחתה<br>`;
...
export default declinePermissionEmail;
